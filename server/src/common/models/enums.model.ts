...
export const userRoleEnum = z.enum([
  "user",
  "admin"
]).openapi({ description: "User role in the system" });

export const libraryMemberRoleEnum = z.enum([
  "owner",
  "manager", 
  "staff",
  "member"
...
export const borrowRequestStatusEnum = z.enum([
  "pending",
  "approved",
  "rejected", 
  "borrowed",
...
export const bookLanguageEnum = z.enum([
  "en",
  "ar",
  "other"
