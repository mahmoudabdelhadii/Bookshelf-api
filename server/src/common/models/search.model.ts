...
export const librarySearchRequestSchema = z
  .object({
    ...
    hasBook: z
      .string()
      .optional()
      .openapi({ description: "Search libraries that have a specific book (by title or ISBN)" }),
...
export const authorSearchRequestSchema = z
  .object({
...
export const publisherSearchRequestSchema = z
  .object({
...
export const borrowRequestSearchRequestSchema = z
  .object({
