...
// Book search filters
export const bookSearchFiltersSchema = z.object({
...
export const librarySearchFiltersSchema = z.object({
  query: z.string().optional().openapi({
...
export const authorSearchFiltersSchema = z.object({
  query: z.string().optional().openapi({
...
export const publisherSearchFiltersSchema = z.object({
  query: z.string().optional().openapi({
...
export const borrowRequestSearchFiltersSchema = z.object({
  ...
  status: z.enum(["pending", "approved", "rejected", "borrowed", "returned", "overdue"]).optional().openapi({
...
export const libraryMemberSearchFiltersSchema = z.object({
  libraryId: z.string().uuid().optional().openapi({
    description: "Filter by library ID",
  }),
  userId: z.string().uuid().optional().openapi({
...
export const advancedSearchSchema = z.object({
  ...
  entityTypes: z.array(z.enum(["book", "library", "author", "publisher", "user"])).optional().openapi({
...
export const facetedSearchFiltersSchema = z.object({
...
export const searchSuggestionSchema = z.object({
  ...
  entityTypes: z.array(z.enum(["book", "author", "publisher", "library", "subject"])).optional().openapi({
