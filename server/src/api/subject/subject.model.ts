...
export const subjectSchema = z
  .object({
    ...
    name: z
      ...
      .openapi({ description: "Subject name" }),
    description: z
      .string()
      .max(500, "Description cannot exceed 500 characters")
      .nullable()
      .optional()
      .openapi({ description: "Subject description" }),
    parent: idSchema
      .nullable()
      .optional()
      .openapi({ description: "Parent subject ID for hierarchical structure" }),
    booksCount: z
      .number()
      .int()
      .min(0)
      ...
      .nullable()
      .optional()
      .openapi({ description: "Number of books in this subject" }),
...
export const subjectWithChildrenSchema = subjectSchema
  .extend({
    children: z
      .array(subjectSchema)
      .optional()
      .openapi({ description: "Child subjects (limited to one level for OpenAPI)" }),
    totalBooksIncludingChildren: z
      .number()
      .int()
      .min(0)
      .optional()
      .openapi({ description: "Total books including all child subjects" }),
...
export const subjectWithStatsSchema = subjectSchema
  .extend({
    ...
    popularBooks: z
      ...
      .optional()
      .openapi({ description: "Most popular books in this subject" }),
