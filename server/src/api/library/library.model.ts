...
export const updateLibrarySchema = createLibrarySchema
  .partial()
  .openapi({ description: "Library update data" });
...
export const libraryWithStatsSchema = libraryWithOwnerSchema
  .extend({
    ...
    recentActivity: z
      ...
      .optional()
      .openapi({ description: "Recent library activity" }),
  })
...
export const libraryDetailedSchema = libraryWithStatsSchema
  .extend({
    members: z
      ...
      .optional()
      .openapi({ description: "Library members" }),
    topGenres: z
      .array(
        z.object({
          genre: z.string(),
      ...
      .optional()
      .openapi({ description: "Most common genres in library" }),
  })
