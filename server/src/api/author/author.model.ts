...
export const authorSchema = z
  .object({
    ...
    name: z
      ...
      .openapi({ description: "Author's full name" }),
    biography: z
      .string()
      .max(2000, "Biography cannot exceed 2000 characters")
      .nullable()
      .optional()
      .openapi({ description: "Author biography" }),
    nationality: z
      .string()
      .max(50, "Nationality cannot exceed 50 characters")
      .nullable()
      .optional()
      .openapi({ description: "Author's nationality" }),
    birthDate: z
      .date()
      .max(new Date(), "Birth date cannot be in the future")
      .nullable()
      .optional()
      .openapi({ description: "Author's birth date" }),
  ...
  .object({
    params: z.object({
      name: z
        .string()
        .min(1, "Author name is required")
        .openapi({ description: "Author name to search for" }),
    }),
  })
  ...
  .object({
    params: z.object({
      query: z
        ...
        .openapi({ description: "Search query for authors" }),
    }),
  })
...
export const authorWithStatsSchema = authorSchema
  .extend({
    averageRating: z
      ...
      .nullable()
      .optional()
      .openapi({ description: "Average rating of author's books" }),
    totalBorrows: z
      .number()
      .int()
      .min(0)
      .optional()
      .openapi({ description: "Total times author's books have been borrowed" }),
    popularBooks: z
      .array(
        z.object({
          id: idSchema,
