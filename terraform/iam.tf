...
resource "aws_iam_policy" "ecs_execution_secrets_policy" {
  ...
  description = "IAM policy for ECS task execution to access secrets"
...
# Attach custom secrets policy to ECS execution role
...
# Policy for ECS task role to access AWS services
